...
public class EsLimit extends ASTNodeAccessImpl {
    ...
    public EsLimit withRowCount(Expression rowCount) {
        this.setRowCount(rowCount);
        return this;
    }

    public EsLimit withOffset(Expression offset) {
        this.setOffset(offset);
        return this;
    }

    @Deprecated
    public EsLimit withLimitAll(boolean limitAll) {
        this.setLimitAll(limitAll);
        return this;
    }

    @Deprecated
    public EsLimit withLimitNull(boolean limitNull) {
