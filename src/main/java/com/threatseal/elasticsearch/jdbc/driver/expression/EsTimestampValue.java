 ...
 */
public final class EsTimestampValue extends BranchImpl {

    private Timestamp value;
    private String rawValue;
    private static final char QUOTATION = '\'';

    public EsTimestampValue() {
        // empty constructor
    }

    public EsTimestampValue(String value) {
        //        if (value == null) {
    ...
    public EsTimestampValue withValue(Timestamp value) {
        this.setValue(value);
        return this;
    }
}
