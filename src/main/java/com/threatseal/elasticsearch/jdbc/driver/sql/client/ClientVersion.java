 ...
 * <p>
 * The class provides the SQL clients the version identifying the release
 * they're are part of. The version is read from the encompassing JAR file
 * (Elasticsearch-specific attribute in the manifest). The class is also a
 * provider for the implemented JDBC standard.
 * </p>
 */
public class ClientVersion {
    ...
    static SqlVersion extractVersion(URL url) {
        ...
        return version != null ? SqlVersion.fromString(version) : new SqlVersion(5, 6, 0);
    }
