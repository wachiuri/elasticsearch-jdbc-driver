...
public class EsAlias {
    ...
    public EsAlias(String name) {
        this.name = name;
    }

    public EsAlias(String name, boolean useAs) {
        this.name = name;
        this.useAs = useAs;
    }
    ...
    public EsAlias withName(String name) {
        this.setName(name);
        return this;
    }

    public EsAlias withUseAs(boolean useAs) {
        this.setUseAs(useAs);
        return this;
    }

    public EsAlias withAliasColumns(List<AliasColumn> aliasColumns) {
        this.setAliasColumns(aliasColumns);
        return this;
    }

    public EsAlias addAliasColumns(AliasColumn... aliasColumns) {
    ...
    public EsAlias addAliasColumns(Collection<? extends AliasColumn> aliasColumns) {
        List<AliasColumn> collection = Optional.ofNullable(getAliasColumns()).orElseGet(ArrayList::new);
