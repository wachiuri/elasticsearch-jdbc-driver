 ...
 */
public final class EsStringValue extends com.threatseal.elasticsearch.jdbc.driver.expression.BranchImpl{
    ...
    public EsStringValue() {
        // empty constructor
    }

    public EsStringValue(String escapedValue) {
    ...
    public EsStringValue withPrefix(String prefix) {
        this.setPrefix(prefix);
        return this;
    }

    public EsStringValue withValue(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        EsStringValue that = (EsStringValue) o;
