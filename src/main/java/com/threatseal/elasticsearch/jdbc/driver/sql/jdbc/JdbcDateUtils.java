...
import static com.threatseal.elasticsearch.jdbc.driver.proto.StringUtils.ISO_DATETIME_WITH_NANOS;
import static com.threatseal.elasticsearch.jdbc.driver.proto.StringUtils.ISO_TIME_WITH_NANOS;

/**
 * JDBC specific datetime specific utility methods. Because of lack of visibility, this class borrows code
 * from {@code org.elasticsearch.xpack.sql.util.DateUtils} and {@code com.threatseal.elasticsearch.jdbc.driver.proto.StringUtils}.
 */
