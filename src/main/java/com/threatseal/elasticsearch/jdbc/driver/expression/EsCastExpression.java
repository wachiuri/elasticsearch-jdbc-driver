...
public class EsCastExpression extends BranchImpl{
    ...
    public EsCastExpression withRowConstructor(EsRowConstructor rowConstructor) {
    ...
    public EsCastExpression withType(ColDataType type) {
        this.setType(type);
        return this;
    }

    public EsCastExpression withUseCastKeyword(boolean useCastKeyword) {
        this.setUseCastKeyword(useCastKeyword);
        return this;
    }

    public EsCastExpression withLeftExpression(Branch leftExpression) {
