...
public class EsRowConstructor extends BranchImpl {

    private EsExpressionList exprList;
    private ArrayList<ColumnDefinition> columnDefinitions = new ArrayList<>();
    private String name = null;

    public EsRowConstructor() {
    }
    ...
    public EsExpressionList getExprList() {
        return exprList;
    }

    public void setExprList(EsExpressionList exprList) {
    ...
    public EsRowConstructor withExprList(EsExpressionList exprList) {
        this.setExprList(exprList);
        return this;
    }

    public EsRowConstructor withName(String name) {
        this.setName(name);
        return this;
    }
}
