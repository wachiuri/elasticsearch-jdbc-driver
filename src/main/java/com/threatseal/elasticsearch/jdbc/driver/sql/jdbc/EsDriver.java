...
public class EsDriver implements Driver {
    ...
    /**
     * Cleanup method invoked by the DriverManager when unregistering the
     * driver. Since this happens typically when the JDBC driver gets unloaded
     * (from the classloader) cleaning all debug information is a good safety
     * check.
     */
    private void close() {
        Debug.close();
